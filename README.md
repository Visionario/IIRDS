...
Usefull if you are mobile with your smartphone and not have a PC
...
# Installing
a) Install midori browser and run for first time
b) Login to http://ingress.com/intel with your credentials and check if you can open any map
c) Close Midori
d) Copy directory '~/.config/midori' to your directory and rename to 'midori_config_base' (this save your credentials and cookies inside)
